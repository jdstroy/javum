  ...
  char **argv;
{
  ...
  while ((p = readdir(d)) != ((void *)0))
  {
    if (strcmp(p->d_name , ".") != 0 && strcmp(p->d_name , "..") != 0)
    {
      ...
      stat(path, &s);
      if ((s.st_mode & 0170000) == 0100000)
      {
        strcpy(f->name, p->d_name);
        f->permissions = s.st_mode & (04000 + 02000 + 01000) + ((0400|0200|0100) + ((0400|0200|0100) >> 3) + (((0400|0200|0100) >> 3) >> 3));
        if (first == ((void *)0))
        {
          first = f;
          f->next = ((void *)0);
        ...
        {
          struct file *l;
          for (l = first; l->next != ((void *)0); l = l->next)
  ...
  while (first != ((void *)0))
  {
    ...
    {
      if (((*__ctype_b_loc ())[(int) ((*t))] & (unsigned short int) _ISupper))
      {
        struct file *previous = first;
        struct file *duplicate = first->next;
        while (duplicate != ((void *)0))
        {
    ...
    if ((first->permissions & ((0400|0200|0100) + ((0400|0200|0100) >> 3) + (((0400|0200|0100) >> 3) >> 3))) != ((0400|0200|0100) + (0400 >> 3) + (0100 >> 3) + ((0400 >> 3) >> 3) + ((0100 >> 3) >> 3)))
    {
      printf("  Changing permissions from %s to %s\n",
        permissions(first->permissions), permissions(((0400|0200|0100) + (0400 >> 3) + (0100 >> 3) + ((0400 >> 3) >> 3) + ((0100 >> 3) >> 3))));
      if (chmod(new_path, first->permissions & (04000 + 02000 + 01000) | ((0400|0200|0100) + (0400 >> 3) + (0100 >> 3) + ((0400 >> 3) >> 3) + ((0100 >> 3) >> 3))) != 0)
      {
